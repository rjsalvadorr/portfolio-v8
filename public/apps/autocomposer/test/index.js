            ...
            _createClass(Player, [
              ...
              },
              {
                ...
                value: function validate() {
                  return (
                    Utils.bytesToLetters(this.buffer.slice(0, 4)) === "MThd"
                  )
                },
   ...
   */
                  ...
                  this.buffer.forEach(function (byte, index) {
                    if (
                      Utils.bytesToLetters(
                        this.buffer.slice(index, index + 4)
                      ) == "MTrk"
                    ) {
                      var trackLength = Utils.bytesToNumber(
                        this.buffer.slice(index + 4, index + 8)
                      )
                      this.tracks.push(
                        new Track(
                          this.tracks.length,
                          this.buffer.slice(index + 8, index + 8 + trackLength)
                        )
                      )
                    }
                  }, this)
              ...
              },
              {
                ...
                value: function getSongPercentRemaining() {
                  return Math.round(
                    (this.getSongTimeRemaining() / this.getSongTime()) * 100
                  )
                },
              ...
              },
              {
                ...
                value: function handleEvent(currentTick, dryRun) {
                  ...
                  if (
                    ...
                    (dryRun || currentTick - this.lastTick >= this.getDelta())
                  ) {
                  ...
                  if (this.data[eventStartIndex] == 0xff) {
                    ...
                    switch (this.data[eventStartIndex + 1]) {
                      ...
                      default:
                        eventJson.name =
                          "Unknown: " +
                          this.data[eventStartIndex + 1].toString(16)
                        break
                    }
                    ...
                    if (this.data[eventStartIndex] < 0x80) {
                      ...
                      eventJson.noteName =
                        Constants.NOTES[this.data[eventStartIndex]]
                      ...
                      if (this.data[eventStartIndex] <= 0x8f) {
                        ...
                        eventJson.noteName =
                          Constants.NOTES[this.data[eventStartIndex + 1]]
    ...
    13: [
                        ...
                        this.pitch.forEach(function (p, i) {
                          if (i == 0) {
                            noteOn = new NoteOnEvent({
                              data: Utils.numberToVariableLength(
                                restDuration
                              ).concat(
            ...
            _createClass(Track, [
              ...
              },
              {
                ...
                value: function setTimeSignature(
                  ...
                  event.data = event.data.concat(
                    Utils.numberToBytes(_denominator, 1)
                  ) // Denominator, 1 bytes
                  event.data = event.data.concat(
                ...
                value: function trackFromVoice(voice) {
                  ...
                  voice.tickables.forEach(function (tickable, i) {
                    ...
                    track.addEvent(
                      new NoteEvent({
                        pitch: pitches,
                        duration: this.convertDuration(voice.tickables[i]),
                        wait: wait,
                      })
                    )
          ...
          var Writer = (function () {
            function Writer(tracks) {
              ...
              tracks.forEach(function (track, i) {
                track.addEvent(
                  new MetaEvent({ data: Constants.META_END_OF_TRACK_ID })
                )
              ...
              },
              {
                ...
                value: function base64() {
                  if (typeof btoa === "function")
                    return btoa(
                      String.fromCharCode.apply(null, this.buildFile())
                    )
      ...
      { _process: 16, buffer: 8, "tonal-midi": 36 },
    ],
    14: [
      function (require, module, exports) {
        ;(function (global) {
    ...
    24: [
      ...
      { "./legacy": 25, "audio-loader": 5, "sample-player": 18 },
    ],
    25: [
      function (require, module, exports) {
        "use strict"
    ...
    26: [
      function (require, module, exports) {
        ...
        function listToStr(v) {
          return tonalPitch.isPitch(v)
            ? tonalPitch.strPitch(v)
            : isArr(v)
            ? v.map(asPitchStr)
            : v
        }
    ...
    28: [
      function (require, module, exports) {
        ...
        var dict = tonalDictionary.dictionary(DATA, function (str) {
          return str.split(" ")
        })
        ...
        function notes(chord) {
          ...
          return ivls
            ? tonalHarmonizer.harmonize(ivls, p.tonic)
            : tonalArray.compact(tonalArray.map(tonalNote.note, chord))
        }
    ...
    29: [
      ...
      { "tonal-array": 26, "tonal-note": 38, "tonal-pcset": 39 },
    ],
    30: [
      function (require, module, exports) {
        "use strict"
        ...
        function substr(a, b) {
          ...
          if (tonalPitch.isPC(a))
            return tonalPitch.pitch(f, -Math.floor((f * 7) / 12), 1)
    ...
    33: [
      function (require, module, exports) {
        ...
        function harmonics(list) {
          ...
          return a.length
            ? tonalArray.compact(a.map(tonalDistance.interval(a[0])))
            : a
        }
        ...
        function harmonize(list, pitch) {
          ...
          return function (tonic) {
            return tonalArray.compact(
              tonalArray.map(tonalTranspose.transpose(tonic || "P1"), list)
            )
          }
        }
      ...
      { "tonal-array": 26, "tonal-distance": 30, "tonal-transpose": 53 },
    ],
    34: [
      function (require, module, exports) {
        "use strict"
      ...
      { "interval-notation": 10, "tonal-pitch": 46 },
    ],
    35: [
      function (require, module, exports) {
        "use strict"
        ...
        var SCALES = [0, 1, 2, 3, 4, 5, 6, 0, 5].map(function (n) {
          return tonalHarmonizer.harmonics(
            tonalArray.rotate(n, ["C", "D", "E", "F", "G", "A", "B"])
          )
        })
        ...
        function majorKey(n) {
          return toKey(tonalTranspose.trFifths("C", n), "major")
        }
        ...
        function props(str) {
          ...
          if (ndx === -1) {
            ...
            key = {
              tonic: tonalNote.pc(str.slice(0, ndx)),
              mode: validMode(str.slice(ndx + 1)),
            }
          }
        ...
        function relative(rel, key) {
          ...
          var tonic = tonalTranspose.trFifths(
            key.tonic,
            modeNum(rel.mode) - modeNum(key.mode)
          )
        ...
        function alteredNotes(key) {
          ...
          return alt === null
            ? null
            : alt < 0
            ? tonalRange.numeric([-1, alt]).map(tonalTranspose.trFifths("F"))
         ...
         */
        function fromAcc(s) {
          return tonalNotation.areSharps(s)
            ? majorKey(s.length)
            : tonalNotation.areFlats(s)
            ? majorKey(-s.length)
            : null
        }
        ...
        function scale(key) {
          ...
          return tonalHarmonizer.harmonize(
            SCALES[MODES.indexOf(p.mode)],
            p.tonic
          )
        }
    ...
    38: [
      function (require, module, exports) {
        ...
        function fromProps(props) {
          return props
            ? noteParser.build(props.step, props.alt, props.oct)
            : null
        }
    ...
    39: [
      function (require, module, exports) {
        ...
        function notes(notes) {
          ...
          var rotated = tonalArray
            .rotate(pitchChr(tonic), chroma(pcs).split(""))
            .join("")
      ...
      function (require, module, exports) {
        ...
        function fromEqualTemp(ref) {
          return function (freq) {
            var midiNum =
              (12 * (Math.log(freq) - Math.log(ref))) / Math.log(2) + 69
    ...
    44: [
      function (require, module, exports) {
        ...
        function encode$1(s, a, o, dir) {
          return dir
            ? ["tnlp", tonalEncoding.encode(s, a, o), dir]
            : ["tnlp", tonalEncoding.encode(s, a, o)]
        }
      ...
      { "interval-notation": 10, "note-parser": 15, "tonal-encoding": 40 },
    ],
    45: [
      function (require, module, exports) {
        "use strict"
        ...
        function transpose(a, b) {
          ...
          var pa = tonalPitch.asPitch(a)
          var pb = tonalPitch.asPitch(b)
          var r = tonalPitch.isIvlPitch(pa)
            ? trBy(pa, pb)
            : tonalPitch.isIvlPitch(pb)
            ? trBy(pb, pa)
            : null
    ...
    46: [
      ...
      { "interval-notation": 10, "note-parser": 15, "tonal-encoding": 31 },
    ],
    47: [
      function (require, module, exports) {
        "use strict"
    ...
    48: [
      function (require, module, exports) {
        ...
        var ROMAN =
          /^\s*(b|bb|#|##|)(IV|III|II|I|VII|VI|V|iv|iii|ii|i|vii|vi|v)\s*(.*)\s*$/
        /**
        ...
        function parseRomanChord(str) {
          ...
          if (m[1][0] === "b") alt = -alt
          return {
            root: tonalInterval.fromProps({ num: num, alt: alt, dir: 1 }),
            type: m[3],
          }
        }
 ...
 */
    ...
    50: [
      function (require, module, exports) {
        ...
        function notes(name) {
          ...
          var notes = scale.tonic
            ? get(scale.type, tonalNote.pc(scale.tonic))
            : null
          return (
            notes ||
            tonalArray.compact(
              tonalArray.map(tonalNote.pc, name).map(function (n, i, arr) {
    ...
    52: [
      function (require, module, exports) {
        ...
        function density(list) {
          var a, b, i
          var notes = tonalArray.compact(
            tonalArray.map(tonalPitch.asNotePitch, list)
          )
          ...
          for (a = 0; a < len; a++) {
            for (b = a; b < len; b++) {
              i = tonalInterval.ic(
                tonalPitch.chr(notes[b]) - tonalPitch.chr(notes[a])
              )
      ...
      { "tonal-array": 26, "tonal-interval": 34, "tonal-pitch": 46 },
    ],
    53: [
      function (require, module, exports) {
        "use strict"
    ...
    */
            ...
            Soundfont.instrument(ac, "clavinet", {
              ...
              clavinet.schedule(ac.currentTime + 5, [
                { time: 0, note: 60 },
                { time: 0.5, note: 61 },
              ])
            })
  ...
  */
      ...
      {
        "../../src/autocomposer-logic": 58,
        "../../src/autocomposer-melody": 59,
      },
    ],
    57: [
      function (require, module, exports) {
    ...
    58: [
      ...
      { "tonal-chord": 28, "tonal-note": 38, "tonal-range": 49 },
    ],
    59: [
      function (require, module, exports) {
        var tonal = require("tonal")
        ...
        class AutoComposerMelody {
          ...
          constructor(chordProgression, lowerLimit, upperLimit) {
            ...
            this.chordProgression =
              chordProgression || AcLogic.INITIAL_PROGRESSION
            /** @type {string} */
          ...
          _sendStatusUpdate(message) {
            var updateEvent = new CustomEvent("statusUpdate", {
              detail: message,
            })
          ...
          _getLowestNoteInRange(pitch, lowerLimit, upperLimit) {
            var chordTonesInRange = tonal.range.pitchSet(pitch, [
              lowerLimit,
              upperLimit,
            ])
          ...
          buildSimpleAccompaniment(melodyUnit) {
            ...
            for (var i = 0; i < melodyUnit.chordProgression.length; i++) {
              ...
              chordNotes = this._removePitchesFromChordTones(chordNotes, [
                topPitch,
              ])

              for (var j = 0; j < chordNotes.length; j++) {
                chordNotes[j] = this._getLowestNoteInRange(
                  chordNotes[j],
                  AcLogic.ACCOMPANIMENT_LOWER_LIMIT,
                  AcLogic.ACCOMPANIMENT_UPPER_LIMIT
                )
              }
          ...
          getBasicBassLine(melodyUnit) {
            ...
            for (var i = 0; i < melodyUnit.chordProgression.length; i++) {
              currentChord = melodyUnit.chordProgression[i]
              bassPitch = tonal.chord.parse(currentChord)["tonic"]
              bassNote = this._getLowestNoteInRange(
                bassPitch,
                AcLogic.BASS_LOWER_LIMIT,
                AcLogic.BASS_UPPER_LIMIT
              )
          ...
          getAllChordTones(chord, lowerLimit, upperLimit) {
            ...
            var chordTonesInRange = tonal.range.pitchSet(chordTones, [
              lowerLimit,
              upperLimit,
            ])
            ...
            for (var i = 0; i < chordTonesInRange.length; i++) {
              for (var j = 0; j < chordTones.length; j++) {
                ...
                if (
                  tonal.note.pc(chordTonesInRange[i]) != chordTones[j] &&
                  tonal.note
                    .enharmonics(chordTones[j])
                    .indexOf(tonal.note.pc(chordTonesInRange[i])) > -1
                ) {
                  chordTonesInRange[i] =
                    chordTones[j] + tonal.note.oct(chordTonesInRange[i])
                }
              }
            }
          ...
          buildChordUnit(chord, lowerLimit, upperLimit) {
            var chordTonesInRange = this.getAllChordTones(
              chord,
              lowerLimit,
              upperLimit
            )
            var chordUnit = new ChordUnit.ChordUnit(
              chord,
              chordTonesInRange,
              null
            )
          ...
          buildMelodyUnit(chordProgression, melodyString) {
            ...
            var melodyUnit = new MelodyUnit.MelodyUnit(
              chordProgression,
              arrMelody
            )
            return melodyUnit
          ...
          buildMelodyUnitList(chordProgression, rawMelodies, options) {
            ...
            rawMelodies.forEach(function (rawMelody) {
              melodyUnits.push(
                haxThis.buildMelodyUnit(chordProgression, rawMelody)
              )
            })
          ...
          buildChordUnitList(chordProgression, lowerLimit, upperLimit) {
            ...
            for (var i = chordProgression.length - 1; i >= 0; i--) {
              chordTonesInRange = this.getAllChordTones(
                chordProgression[i],
                lowerLimit,
                upperLimit
              )
              ...
              if (i === chordProgression.length) {
                chordUnitList[i] = new ChordUnit.ChordUnit(
                  chordProgression[i],
                  chordTonesInRange,
                  null
                )
          ...
          buildSimpleMelodiesCore(chordUnit, melodyList, options) {
            ...
            if (chordUnit.nextChordUnit) {
              ...
              return this.buildSimpleMelodiesCore(
                chordUnit.nextChordUnit,
                returnList,
                options
              )
            } else {
              ...
              if (
                options.filtered &&
                returnList.length > AcLogic.NUM_MELODIES_LIMIT
              ) {
                this._sendStatusUpdate(
                  "Generated  " +
                    returnList.length +
                    " melodies. Creating list of " +
                    AcLogic.NUM_MELODIES_LIMIT +
                    "..."
                )
              } else {
                this._sendStatusUpdate(
                  "Generated  " + returnList.length + " melodies."
                )
              }
              return returnList
            }
          ...
          buildAllMelodies(chordProgression) {
            var chordUnitList = this.buildChordUnitList(
              chordProgression,
              this.lowerLimit,
              this.upperLimit
            )
            var melodies = this.buildSimpleMelodiesCore(
              chordUnitList[0],
              null,
              { filtered: false }
            )
          ...
          buildSimpleMelodies(chordProgression, options) {
            ...
            if (options) {
              ...
              rawOption =
                options.raw && (options.raw === "true" || options.raw === true)
                  ? true
                  : false
              filterOption =
                typeof options.filter !== "undefined" &&
                (options.filter === "false" || options.limit === false)
                  ? false
                  : true
              if (
                typeof options.filter !== "undefined" &&
                (options.limit === "false" || options.limit === false)
              ) {
                limitOption = null
                sortOption = false
              } else {
            ...
            rawMelodies = this.buildSimpleMelodiesCore(chordUnitList[0], null, {
            ...
            melodyUnits = this.buildMelodyUnitList(
              chordProgression,
              rawMelodies,
              { sort: sortOption, limit: limitOption }
            )
            return melodyUnits
          }
        }
      ...
      function (require, module, exports) {
        ...
        class AutoComposerMidi {
            ...
            for (var instrumentRole in this.instrumentData) {
              ...
              if (typeof this.instrumentData[instrumentRole] !== "function")
                Soundfont.instrument(
                  this.audioContext,
                  haxThis.instrumentData[instrumentRole].name,
                  { soundfont: "FluidR3_GM" }
                ).then(function (sfInstrument) {
                  currentInstrument = haxThis.instrumentData.getByName(
                    sfInstrument.name
                  )
                  ...
                  console.log(
                    "[INNER FUNCTION] instrumentRole=" + instrumentRole
                  )
          ...
          _buildTrack(arrChordNotes, instrumentData) {
            ...
            returnTrack.addEvent(
              new MidiWriter.ProgramChangeEvent({
                instrument: instrumentData.midiInstrumentCode,
              })
            )
            ...
            for (var i = 0; i < arrChordNotes.length; i++) {
              ...
              returnTrack.addEvent(
                this._buildMidi(midiNumbers, this.NOTE_DURATION)
              )
            }
          ...
          _buildMelodyMidiSolo(arrMelody) {
            var tracks = [],
              midiNumber
            tracks[0] = this._buildTrack(
              arrMelody,
              this.instrumentData["melody"]
            )
           ...
           * @return {string} - MIDI data, as a DataURI string.
           */
          buildMelodyMidiWithAccompaniment(
            arrMelody,
            arrAcompanimentLine,
            arrBassLine
          ) {
            ...
            var melodyTrack = this._buildTrack(
              arrMelody,
              this.instrumentData["melody"]
            )
            var accompanimentTrack = this._buildTrack(
              arrAcompanimentLine,
              this.instrumentData["accompaniment"]
            )
            var bassTrack = this._buildTrack(
              arrBassLine,
              this.instrumentData["bass"]
            )
          ...
          playMelodyWithAccompaniment(melodySolo, melodyAccomp, melodyBass) {
            var strMidi = this.buildMelodyMidiWithAccompaniment(
              melodySolo,
              melodyAccomp,
              melodyBass
            )
          ...
          _playMelody(strMidi) {
            if (this.initialized) {
              ...
              console.warn(
                "[AutoComposerMidi._playMelody()] Player isn't initialized yet..."
              )
            }
          }
